...
<table class="table table-striped table table-bordered">
    <div class="dashboard-tinta-container">
        ...
        <a href="/indexTonner"  style="margin-left: 5px" class="btn btn-dark"><ion-icon name="repeat-outline"></ion-icon> Tonners</a>
    ...
    <h1>Tintas
        ...
        <div id="search-container-tonner" class="col-sm-6 col-md-6">
            <form action="/indexTinta" method="POST">
                @csrf
